...
version = "1.0.1"
source = {tag = "v1.0.1", url = "git+ssh://git@github.com/ccuser44/rapid-match-domain.git"}
description = {
    summary = "A fast Lua library to check if a domain name in a list of domain names. Wildcards, subdomains, portnumbers and IP address support.",
    license = "MIT",
